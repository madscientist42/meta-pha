# All the Ruby-centric builder classes ("ruby" for gem specific build-outs, "bundler" for, well, bundler stuff)
# need these specific declarations and functions to work.  (Hence, "ruby-core")
